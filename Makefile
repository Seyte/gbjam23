...
main: $(OBJDIR)main.o $(OBJDIR)Sprite.o $(OBJDIR)DisplayManager.o $(OBJDIR)Color.o $(OBJDIR)Position.o $(OBJDIR)GameObject.o $(OBJDIR)Player.o $(OBJDIR)utils.o $(OBJDIR)StaticSprites.o $(OBJDIR)CollisionBox.o $(OBJDIR)SpaceShip.o $(OBJDIR)AnimatedSprites.o $(OBJDIR)InvisibleWall.o $(OBJDIR)Interactable.o $(OBJDIR)SpaceShipPart.o $(OBJDIR)DynamicGameObject.o $(OBJDIR)Asteroid.o
